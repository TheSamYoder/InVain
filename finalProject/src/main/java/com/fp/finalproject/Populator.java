...
public class Populator implements CommandLineRunner {
    ...
    @Override public void run(String...args) throws Exception{
        ...
        Professional christian = new Professional("Christian Rivea","Cool dude!", 5.3,
                "Filler", true, "Barber","https://bit.ly/3iLxgLb","123456789",
        ...
        Professional bri = new Professional("Bri Phillips", "Good stylist", 5.6,
        ...
        Professional mandy = new Professional("Mandy Moore", "Good nails", 5.1,
        ...
        Professional eli = new Professional("Eli Wagner", "Great hair cuts!", 5.0,
